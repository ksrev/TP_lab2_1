...
bool Sign::operator>(Sign& sign) {
	return (birthDate[2] > sign.birthDate[2]) ||
		(birthDate[2] == sign.birthDate[2] && birthDate[1] > sign.birthDate[1]) ||
		(birthDate[2] == sign.birthDate[2] && birthDate[1] == sign.birthDate[1] && birthDate[0] > sign.birthDate[0]);
}